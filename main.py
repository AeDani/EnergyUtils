...
##--- initialer Hedge
hedge = Hedging(evu25)
hedge.calc_quantity_hedge(Products.cal, Hours.base)
hedge.print_hedge()
hedge.calc_quantity_hedge(Products.cal, Hours.peak)
hedge.print_hedge()
hedge.calc_quantity_hedge(Products.cal, Hours.off_peak)
hedge.print_hedge()
#hedge.plot_hedge()
...
op_hd = Hedging(op)
op_hd.calc_quantity_hedge(Products.q, Hours.base)
op_hd.print_hedge()
# hedge.plot_hedge()
